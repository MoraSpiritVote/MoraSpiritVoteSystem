		...
		<div class="container-table100" style="background:#e9ecf2;">
				...
				<div class="table100">
					...
					<?php
						...
						<div id="'.$id.'" class="modal">
							...
							<!-- Modal Content -->
							<form class="modal-content animate" method="Post" enctype="multipart/form-data" action="playersEditProccess.php?id='.$id.'">
							<div class="imgcontainer">
								<img src="img/team/member-1.png" alt="Avatar" class="avatar" onclick="document.getElementById(\'photoChooser\').style.display=\'block\'" >
							...
							<div class="vote_container">
								...
								<input type="file" id="photoChooser" style="display:none;" >
								<br>
			...
			<div id="id01" class="modal">
				...
				<div class="vote_container">
					...
					<button class="vote_button" style="width: 80px;" type="submit">Submit</button>
