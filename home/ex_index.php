			...
			<div class="container">
				<div class="row" style="align-content: center";>
					...
					<div class="project-wrapper" style="margin-left:30%;" >
						...
						<h3 class="sec-sub-title">Player that You have Voted</h3>
							<br>

							<figure class="mix work-item">
								<img src="img/players/5.jpg" alt="" width="400px" height="300px">
								<figcaption class="overlay">
									...
									<p>Photography</p>
									<button class="vote_button"  onclick="document.getElementById('id01').style.display='block'">Vote</button>
